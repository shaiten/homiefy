...
function AddRentItemScreen(props) {
	...
	const { loading, insertRentItem } = useRent();

	const navigate = useNavigate();

	const [message, setMessage] = useState();
	const [rentItemImage, setRentItemImage] = useState(null);
	...
	const handleAddRentItem = (e) => {
		...
		insertRentItem(rentItem, ({ error, data }) => {
			if (error) {
				console.log("====================================");
				console.log(error);
				console.log("====================================");
			...
			<div className="container">
				<div className="signin-content">
					...
					<div className="signin-form">
						<h2 className="form-title">Add Rent Item</h2>
						<form method="POST" className="register-form" id="rentItem-form">
							<div className="col-md-12">
								<div className="mb-3">
									<input
										...
										ref={image}
										onChange={(event) =>
											setRentItemImage(event.target.files[0])
										}
									/>
								</div>
							</div>
...
export default AddRentItemScreen;
